...
const DocumentCard = ({ document, onDelete }) => {
    ...
    return (
        <article
            ...
            className="group rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm hover:shadow-md transition cursor-pointer"
        >
            {/* Header */}
            <div className="flex items-start justify-between gap-3">
                ...
                <button
                    ...
                    className="p-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/50 text-red-500 dark:text-red-400 transition"
            ...
            {/* Title */}
            <h3 className="mt-3 text-lg font-semibold text-slate-900 dark:text-slate-100 truncate">{document.title}</h3>
